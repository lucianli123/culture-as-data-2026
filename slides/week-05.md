...
- **Reading:** [Kozlowski, Taddy &amp; Evans, The Geometry of Culture (2019)](https://journals.sagepub.com/doi/10.1177/0003122419877135): the argument that directions in an embedding space are cultural findings rather than artifacts
- **Supplement:** The debates, for the curious: [Bolukbasi et al. (2016)](https://arxiv.org/abs/1607.06520) on the same geometry; [Caliskan et al. (2017)](https://arxiv.org/abs/1608.07187) vs. [Soni/Klein, How Words Lead to Justice](https://www.publicbooks.org/how-words-lead-to-justice/); [Anderson et al., Spotify diversity](https://research.atspotify.com/algorithmic-effects-on-the-diversity-of-consumption-on-spotify/)
- **Deeper (optional):** [Wattenberg, Vi&eacute;gas &amp; Johnson, How to Use t-SNE Effectively (Distill 2016)](https://distill.pub/2016/misread-tsne/), before you believe any cluster you see
