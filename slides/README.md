...
python3 slides/week04_figs.py       # ~2 min: fits the models, trains word vectors contrastively on the two novels, convolves a Met painting, and calls the Art Institute, Met and quotes.toscrape endpoints live
