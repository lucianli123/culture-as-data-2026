...
├── kits/        ← handouts: common-errors cheat sheet, licensing one-pager, pivot-kit corpus bank
├── template/    ← the publishing template students fork in Week 4 (Quarto → GitHub Pages)
