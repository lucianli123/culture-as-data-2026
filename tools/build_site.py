...
2:"Count something in a text you love; one chart; one sentence naming a choice. Comparing two things? Shuffle-test it.",
...
SLIDES_THREADS={
1:[("Read work critically","She Giggles, He Gallops is great and its choices are arguable. We admire and interrogate at once, the habit the whole course turns on."),
   ("Make something real","A complete investigation by the first break, before any theory."),
   ("Images are culture too","A picture is numbers: you counted pixels on day one, and images ride along as a co-equal corpus all ten weeks.")],
2:[("Beyond counting","Counting is the honest floor, with no notion of meaning. This sets up the Week 5 payoff."),
   ...
   ("Is the difference real?","Shuffle the labels and count again, a thousand times; if chance often beats your gap, don't trust it.")],
...
WEEKS = [
 ...
 dict(n=2, title="Counting Is Already a Model", tool="Advanced counting: baselines, keyness, and the shuffle test",
   promise="Put a famous PNAS paper on trial, find the words that make a voice distinctive (the method behind Week 1's featured study), and learn the one statistics move the course needs: the shuffle test for whether a difference is real.",
