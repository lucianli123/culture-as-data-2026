...
2:[("Beyond counting","Counting is the honest floor, with no notion of meaning. This sets up the Week 5 payoff."),
   ...
   ("The corpus is a choice","The same counter on lyrics, a subreddit, and a novel gives three different \"commons.\"")],
...
WEEKS = [
 ...
 dict(n=2, title="Counting Is Already a Model", tool="Counting, and every count hides a choice",
   promise="Put a famous PNAS paper on trial, build a word-counter by hand, watch the same sentence get counted three ways, and find an artist's signature vocabulary with nothing but counting.",
