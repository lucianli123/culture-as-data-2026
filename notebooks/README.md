...
| `week04_demo.ipynb` | 2 | demo, run top to bottom | contrastive word vectors trained live on two novels + a convolution worked by hand + a museum API + a polite scrape |
