...
| `week04_demo.ipynb` | 2 | demo, run top to bottom | how a notebook works + contrastive word vectors trained live on two novels + a convolution worked by hand + a small CLIP + two museum APIs explored + a scrape from HTML to stopping rule |
