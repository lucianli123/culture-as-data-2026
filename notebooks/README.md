...
| `week03_modeling_TOGETHER.ipynb` | 1 | guided group work (blank stations + workbench) | worked toy warm-up, then: features / fit / baseline / weights / break it, then a provided workbench (config sweep, weight interrogation, corpus swap) |
